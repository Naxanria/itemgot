package com.naxanria.itemgot.gui.widget;
...
public class TitledWidget<W extends Widget> extends Widget
{
  ...
  public TitledWidget(FontRenderer font, W widget, int x, int y, int width, int height, String message, String title)
  {
  ...
  {
    widget.playDownSound(soundHandler);
  }
}
